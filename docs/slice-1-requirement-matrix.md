...
| S1-003 | CONV-004, CONV-005, CONV-010, EXEC-001, EXEC-002 | Pi 0.82 RPC fixture normalization covers visible text/stream/status/extension UI, diagnostic-only reasoning/tool events, and pre-projection redaction; strict JSONL framing and command discovery fail-closed remain | CERT-002 stream, extension UI, injection, and `agent_settled` |
