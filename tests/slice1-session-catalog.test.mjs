...
assert.deepEqual(projection.provenance, { authority: "pi-session-jsonl" });
assert.equal(projection.omitted.length, 2, "bad cwd and duplicate metadata must be reported generically");
