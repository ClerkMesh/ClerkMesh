...
const fixture = {
  ...
  tasks:[{ id:"task-1", kind:"ship", project:"demo", current_state:{state:"working",source:"pane",detail:"secret terminal detail",observed_at:"2026-08-01T00:00:00Z"}, hints:{pending_decision:false}, pr:{url:null}, paths:{report:{present:true},meta:{path:"/private/meta"}}, endpoint:{target:"private-pane"} }]
};
