...
function validateContext(context) {
  ...
  if (!exactKeys(context.clerk, ["name", "execution", "commit"]) || !NAME.test(context.clerk.name) || context.clerk.execution !== "agent" || !OID.test(context.clerk.commit)) throw new Error("capability requires an Agent Clerk context");
...
export function parseExecutionContextFromBrief(brief) {
